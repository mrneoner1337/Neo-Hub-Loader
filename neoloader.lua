--[[
══════════════════════════════════════════════════════════════════
Neo's Hub v4.0 — Universal Roblox Menu
Author: @mrneoner
...
-- ═══ EXPLOIT API FALLBACKS (Fixes TypeErrors) ═══
local syn = (getgenv and getgenv().syn) or {}
local unlockfps = (getgenv and getgenv().unlockfps)
...
function getHum() return getChar():WaitForChild("Humanoid") end
...
function TC(t) return Color3.fromRGB(t[1], t[2], t[3]) end
...
-- ═══ HELPERS ═══
function tween(obj, props, t, style, dir)
...
function Corner(p, r) return Create("UICorner", {CornerRadius = UDim.new(0, r or 8), Parent = p}) end
...
function RegisterKeybind(name, callback, defaultKey)
    local existing = nil
...
function ShowBlurImmediate()
    if BlurEffect and S.BlurBackground then
        BlurEffect.Size = S.BlurSize or 24
    end
end

function HideBlurImmediate()
    if BlurEffect then
        BlurEffect.Size = 0
    end
end
...
function NotifyModern(title, text, duration)
    ...
    Create("TextLabel", {Size = UDim2.new(1, -60, 0, 36), Position = UDim2.new(0, 54, 0, 28), BackgroundTransparency = 1, Text = text, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top, TextWrapped = true, Parent = inner})
...
function NotifyMinimal(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
    ...
    Create("TextLabel", {Size = UDim2.new(1, -20, 0, 28), Position = UDim2.new(0, 16, 0, 26), BackgroundTransparency = 1, Text = text, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, Parent = notif})
...
function NotifyClassic(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
        BackgroundColor3 = TC(S.Theme.Bg),
        BorderSizePixel = 0,
...
function NotifyGradient(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
        BackgroundColor3 = TC(S.Theme.Bg),
        BorderSizePixel = 0,
    ...
    Create("TextLabel", {Size = UDim2.new(1, -20, 0, 32), Position = UDim2.new(0, 14, 0, 32), BackgroundTransparency = 1, Text = text, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, Parent = notif})
...
function NotifyNeon(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
    ...
    Create("TextLabel", {Size = UDim2.new(1, -28, 0, 34), Position = UDim2.new(0, 14, 0, 44), BackgroundTransparency = 1, Text = text, TextColor3 = Color3.fromRGB(220, 220, 230), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, Parent = notif})
...
function NotifyGlass(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
    ...
    Create("TextLabel", {Size = UDim2.new(1, -20, 0, 32), Position = UDim2.new(0, 14, 0, 34), BackgroundTransparency = 1, Text = text, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, Parent = notif}):SetAttribute("OrigTT", 0)
...
function NotifyCyber(title, text, duration)
    local notif = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 0),
...
local StopAllFly, StartFly, StopFlingIY, StartFlingIY, StopWalkFling, StartWalkFling, StopFlyFling, StartFlyFling
...
Create("TextLabel", {Size = UDim2.new(1, -78, 0, 16), Position = UDim2.new(0, 74, 0, 34), BackgroundTransparency = 1, Text = "@" .. Player.Name, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextTruncate = Enum.TextTruncate.AtEnd, Parent = ProfFrame})
...
function ShowKeybindPopup(name, callback)
...
function Toggle(parent, text, default, callback, keybindName)
...
function Slider(parent, text, min, max, default, callback)
...
function SliderCompact(parent, text, min, max, default, callback)
    local container = Create("Frame", {Size = UDim2.new(1, 0, 0, 44), BackgroundColor3 = TC(S.Theme.Card), BorderSizePixel = 0, Parent = parent}); container:SetAttribute("OrigBT", 0); Corner(container, 10)
...
function Button(parent, text, callback, danger, keybindName)
...
function InfoCard(parent, text, copyable)
    ...
    local l = Create("TextLabel", {Size = UDim2.new(1, -16, 1, 0), Position = UDim2.new(0, 14, 0, 0), BackgroundTransparency = 1, Text = text, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, Parent = f}); l:SetAttribute("OrigTT", 0)
    if copyable then
...
function Dropdown(parent, text, options, callback, refName)
...
function ShowColorPickerPopup(title, default, onApply)
    pcall(function() CoreGui:FindFirstChild("NHColorPicker"):Destroy() end)
...
function ColorPicker(parent, text, default, callback)
    local container = Create("Frame", {Size = UDim2.new(1, 0, 0, 44), BackgroundColor3 = TC(S.Theme.Card), BorderSizePixel = 0, Parent = parent}); container:SetAttribute("OrigBT", 0); Corner(container, 10)
...
function UpdateScreenInfoTheme()
...
function UpdateKeybindPanel()
    ...
    for _, kb in ipairs(KeybindRegistry) do
        if kb.key and kb.key ~= "None" then
            ...
            local row = Create("TextLabel", {Size = UDim2.new(1, 0, 0, 16), BackgroundTransparency = 1, TextColor3 = TC(S.Theme.Text), Font = Enum.Font.GothamMedium, TextSize = 10, TextXAlignment = Enum.TextXAlignment.Left, RichText = true, Parent = KBList})
    ...
    if tmKey ~= "None" then
        count += 1
        Create("TextLabel", {Size = UDim2.new(1, 0, 0, 16), BackgroundTransparency = 1, Text = "[" .. tmKey .. "] Toggle Menu", TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 10, TextXAlignment = Enum.TextXAlignment.Left, LayoutOrder = -1, Parent = KBList})
    end
    if count == 0 then
        Create("TextLabel", {Size = UDim2.new(1, 0, 0, 16), BackgroundTransparency = 1, Text = L("no_keybinds"), TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 10, TextXAlignment = Enum.TextXAlignment.Left, Parent = KBList})
    end
...
do
    ...
    makeESP = function(plr)
        ...
        if S.ESPShowName or S.ESPShowHealth then
            ...
            if S.ESPShowHealth then
                ...
                if hum2 then
                    Create("TextLabel", {Size = UDim2.new(1, 0, 0, 14), Position = UDim2.new(0, 0, 0, 18), BackgroundTransparency = 1, Text = math.floor(hum2.Health) .. " / " .. math.floor(hum2.MaxHealth), TextColor3 = Color3.fromRGB(100, 255, 100), Font = Enum.Font.GothamMedium, TextSize = 12, TextStrokeTransparency = 0.4, Parent = bb})
                end
            end
        end
    ...
    local healthTag = Create("TextLabel", {Size = UDim2.new(0, 60, 0, 10), Position = UDim2.new(0.5, -30, 0, 16), BackgroundTransparency = 1, Text = "100 / 100", TextColor3 = Color3.fromRGB(100, 255, 100), Font = Enum.Font.GothamMedium, TextSize = 8, TextStrokeTransparency = 0.3, Parent = previewArea}); healthTag:SetAttribute("OrigTT", 0)
...
do
    ...
    local selectedJumpScare = jumpScareNames[1] or "-"
    local jumpScarePlayerDD = Dropdown(p, L("select_player"), jumpScareNames, function(val)
    ...
    local stareConn = nil
    local stareTarget = ""
    local stareDD = Dropdown(p, L("stare_at"), jumpScareNames, function(val)
        stareTarget = val
    end, "StarePlayer")
    ...
    local creepyFollowConn = nil
    local creepyTarget = ""
    local creepyDD = Dropdown(p, L("creepy_follow"), jumpScareNames, function(val)
        creepyTarget = val
    end, "CreepyPlayer")
    ...
    function refreshFunPlayerLists()
        local names = {}
        for _, p2 in pairs(Players:GetPlayers()) do if p2 ~= Player then table.insert(names, p2.Name) end end
        if #names == 0 then table.insert(names, "-") end
...
do
    ...
    local cfgBox = Create("TextBox", {Size = UDim2.new(1, -16, 1, 0), Position = UDim2.new(0, 8, 0, 0), BackgroundTransparency = 1, PlaceholderText = L("config_name"), PlaceholderColor3 = TC(S.Theme.SubText), Text = "", TextColor3 = TC(S.Theme.Text), Font = Enum.Font.GothamMedium, TextSize = 13, TextXAlignment = Enum.TextXAlignment.Left, ClearTextOnFocus = false, Parent = cfgIF}); cfgBox:SetAttribute("OrigTT", 0)
...
do
    ...
    Create("TextLabel", {Size = UDim2.new(1, 0, 0, 14), Position = UDim2.new(0, 0, 0, 70), BackgroundTransparency = 1, Text = L("made_with"), TextColor3 = Color3.fromRGB(160, 160, 180), Font = Enum.Font.GothamMedium, TextSize = 11, Parent = banner}):SetAttribute("OrigTT", 0)
    ...
    for _, ver in ipairs(changelogItems) do
        ...
        for _, item in ipairs(ver[3]) do Create("TextLabel", {Size = UDim2.new(1, 0, 0, 16), BackgroundTransparency = 1, Text = "• " .. item, TextColor3 = TC(S.Theme.SubText), Font = Enum.Font.GothamMedium, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, AutomaticSize = Enum.AutomaticSize.Y, Parent = contentFrame}):SetAttribute("OrigTT", 0) end
